...
rootFolder = 'C:\Users\ZheChen\Desktop\folder_all';
...
imgSets = [ imageSet(fullfile(rootFolder, 'large')), ...
            imageSet(fullfile(rootFolder, 'medium')), ...
            imageSet(fullfile(rootFolder, 'small')) ];
...
[trainingSets, validationSets] = partition(imgSets, 30, 'randomize');
...
large = read(trainingSets(1),1);
medium     = read(trainingSets(2),1);
small    = read(trainingSets(3),1);
...
img = imread(fullfile(rootFolder, 'medium', 'img_14.tif'));
