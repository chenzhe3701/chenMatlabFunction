function calculate_strain(matfile, subset_size, fit_val)
...
exx_Logrithmic = zeros(n,m);
exy_Logrithmic = zeros(n,m);
eyy_Logrithmic = zeros(n,m);
...
save(matfile, 'exx_Lagrange', 'exy_Lagrange', 'eyy_Lagrange',...
    'exx_Biot', 'exy_Biot', 'eyy_Biot',...
    'exx_Logrithmic', 'exy_Logrithmic', 'eyy_Logrithmic',...
    '-append')
disp(['...' matfile ' DONE!'])
clear
