...
if any(strcmpi(str1,{'Ti','Titanium','Zr','Zirconium'}))
    ...
    if strcmpi(str2,'twin')
        ...
        ssa(:,:,nss+1) = [1 0 -1 2; -1 0 1 1];
        ssa(:,:,nss+2) = [0 1 -1 2; 0 -1 1 1];
        ssa(:,:,nss+3) = [-1 1 0 2; 1 -1 0 1];
        ssa(:,:,nss+4) = [-1 0 1 2; 1 0 -1 1];
        ssa(:,:,nss+5) = [0 -1 1 2; 0 1 -1 1];
        ssa(:,:,nss+6) = [1 -1 0 2; -1 1 0 1];
    end
