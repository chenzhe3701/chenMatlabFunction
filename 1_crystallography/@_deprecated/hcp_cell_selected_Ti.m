...
euler = [euler_by_twin([285.254,24.464,56.40],5,'ti')];  % artifical orientation in Mg
...
Stress_State = [ -1 0 0; 0 0 0; 0 0 0]; % ----------------------- note stress state ---------------------------- 
...
% extension twin 
Slpsys(25) = struct('number',1,'slp_plane',[1 0 -1 2],'slp_dir',[-1 0 1 1],'n_vertex',4,'plane_index',[1 2 10 11],'burgers_index',[1 11]);
Slpsys(26) = struct('number',2,'slp_plane',[0 1 -1 2],'slp_dir',[0 -1 1 1],'n_vertex',4,'plane_index',[2 3 11 12],'burgers_index',[2 12]);
Slpsys(27) = struct('number',3,'slp_plane',[-1 1 0 2],'slp_dir',[1 -1 0 1],'n_vertex',4,'plane_index',[3 4 12 7],'burgers_index',[3 7]);
Slpsys(28) = struct('number',4,'slp_plane',[-1 0 1 2],'slp_dir',[1 0 -1 1],'n_vertex',4,'plane_index',[4 5 7 8],'burgers_index',[4 8]);
Slpsys(29) = struct('number',5,'slp_plane',[0 -1 1 2],'slp_dir',[0 1 -1 1],'n_vertex',4,'plane_index',[5 6 8 9],'burgers_index',[5 9]);
Slpsys(30) = struct('number',6,'slp_plane',[1 -1 0 2],'slp_dir',[-1 1 0 1],'n_vertex',4,'plane_index',[6 1 9 10],'burgers_index',[6 10]);
...
figure;
plotPool = [1];     % -------- this is where you select what to plot ---------------------------------------------------- ---
