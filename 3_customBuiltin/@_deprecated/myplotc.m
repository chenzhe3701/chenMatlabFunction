...
% chenzhe, 2018-08-26. Modify function name. This is used to select data
% points lower than the threshold value.  Another function based on this
% function was added as 'myplotc_high' to select values higher than
% threshold value.

function [f,a,c,s,v] = myplotc_low(M,varargin)
